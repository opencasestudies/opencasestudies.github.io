...
<a href="blog.html" class="cta-button">Latest Updates</a>
</div>
</div>
...
```{=html}
<p>
  <a class="btn-primary" href="https://www.opencasestudies.org/search_new.html" target="_blank" rel="noopener">
    Browse case studies
  </a>
</p>
```
...
<div style="background-color: #fbb731; color: black; padding: 15px 20px; border-radius: 6px; margin: 10px 20px; border: 1.5px solid #8ab58a; text-align: center;">
<strong>Want to use Open Case Studies for teaching? <br> Learn how to use our case studies and more about the OCS project using our guide:</strong><br>
